...
public final class ConfigManager {
    ...
    public String economyProviderName() { return cfg.getString("economy.provider", "INTERNAL"); }
    ...
    public int maxActiveListingsPerPlayer() { return cfg.getInt("auction.max-active-listings-per-player", 10); }
    ...
    public int listingsPerPage() { return cfg.getInt("auction.listings-per-page", 45); }
